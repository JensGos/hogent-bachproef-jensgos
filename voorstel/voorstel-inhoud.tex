...
De centrale onderzoeksvraag van deze bachelorproef is: ``Hoe ontwerp en realiseer je een performante provisioner voor een virtuele Windows- en Linux omgevingen, die beter inspeelt op de behoeften van onderwijs en bedrijven dan de huidige Vagrant-gebaseerde aanpak?'' Om deze vraag te beantwoorden doen we aan de hand van deze deelvragen:
\begin{itemize}
