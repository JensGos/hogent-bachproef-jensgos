...
Binnen de richting IT infrastructure engineer wordt in HOGENT gebruikgemaakt van verschillende provisioningtools om virtuele Windows- en Linuxomgevingen op te zetten. Een veel gebruikt tool hiervoor is Vagrant, studenten gebruiken dit om een ontwikkel- en labo-omgeving te kunnen automatiseren op basis van een declaratieve configuratiefile.
...
\subsection{Fase 1: Programmeertaal leren}
...
\begin{itemize}
    \item Week 1-2: Leren van programmeer taal
