...
\begin{itemize}
    \item \texttt{ssh2} voor SSH-verbindingen. Dit werd gekozen voor cross-platform compatibiliteit, omdat de ingebouwde SSH-oplossingen van Linux en Windows te verschillend zijn en niet op dezelfde manier het wachtwoord van de gebruiker kunnen verwerken. De crate is een Rust-binding voor \texttt{libssh2}, een SSH-clientbibliotheek, en is dual-licensed onder Apache 2.0 en MIT.\autocite{ssh2Crate}
    ...
    \item \texttt{clap} voor command-line argumenten. Dit werd gekozen omdat het een eenvoudige en gebruiksvriendelijke manier biedt om CLI-argumenten te verwerken. De crate is dual-licensed onder Apache 2.0 en MIT.\autocite{clapCrate}
\end{itemize}
...
\begin{table}[H]
    ...
    \begin{tabular}{lcc}
        \toprule
        \textbf{Test} & \textbf{Vagrant} & \textbf{RustProv} \\
        \midrule
