...
\begin{lstlisting}[language=PowerShell,caption={Voorbeeld van console-uitvoer bij Windows-provisioning na sprint 2.}]
...
\begin{lstlisting}[language=PowerShell,caption={Voorbeeld van console-uitvoer na sprint 5 met meerdere VM's en prioriteit.}]
